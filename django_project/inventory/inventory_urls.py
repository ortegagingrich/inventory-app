...
user_urlpatterns = [
	...
	#/inventory/login/
	url(r'^login/$', actions_user.login_submit, name='login'),
	#/inventory/logout/
	url(r'^logout/$', actions_user.logout_submit, name='logout'),
	#/inventory/profile/
	...
	url(r'^profile/password/submit/$', actions_user.password_submit, name='password_submit'),
	#/inventory/signup/
	...
	#/inventory/5/open/
	url(r'^(?P<item_id>[0-9]+)/open/$', views.item_open_page, name='item_open_page'),
	#/inventory/5/open/submit/
	url(r'^(?P<item_id>[0-9]+)/open/submit/$', 
	    actions_item.item_open_submit, name='item_open_submit'),
	#/inventory/5/move/
	...
	#/inventory/5/delete/
	url(r'^(?P<item_id>[0-9]+)/delete/$', actions_item.item_delete_submit, name='item_delete_submit'),
]
